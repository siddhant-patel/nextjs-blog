...
return (
  <section className="text-white">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-0 sm:py-16 xl:px-8">
          <Image src="/images/about-image.png" alt="Profile Photo" width={500} height={500} />
          <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
              <h2 className="text-4xl font-bold text-white mb-4">About Me</h2>
              <p className="text-base lg:text-lg text-justify">
                  As a highly skilled graduate student in Computer Science at Arizona State University, 
                  with a strong academic background (GPA: 4.0/4.0), I possess a diverse skill set 
                  ...
                  <br></br>
                  Beyond technical prowess, I bring strong communication, problem-solving, leadership, 
